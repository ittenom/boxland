...
// assert it stays in sync with setup.RequiredCmds() (which the TUI
...
func runInstall() error {
	...
	// no obvious way out. The TUI's interactive job slot pipes the
...
func runDesign() error {
	...
	// PATH. Works whether the user started the TUI via `go run`, the
